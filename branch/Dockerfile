...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/2.5.0/couchbase-sync-gateway-enterprise_2.5.0_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-enterprise_2.5.0_x86_64.rpm && \
    rm couchbase-sync-gateway-enterprise_2.5.0_x86_64.rpm
