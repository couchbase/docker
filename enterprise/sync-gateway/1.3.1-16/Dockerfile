...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/1.3.1/couchbase-sync-gateway-enterprise_1.3.1-16_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-enterprise_1.3.1-16_x86_64.rpm && \
    rm couchbase-sync-gateway-enterprise_1.3.1-16_x86_64.rpm
