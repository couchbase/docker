...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/2.1.3/couchbase-sync-gateway-enterprise_2.1.3_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-enterprise_2.1.3_x86_64.rpm && \
    rm couchbase-sync-gateway-enterprise_2.1.3_x86_64.rpm
