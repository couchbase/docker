...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/2.0.0/couchbase-sync-gateway-community_2.0.0_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-community_2.0.0_x86_64.rpm && \
    rm couchbase-sync-gateway-community_2.0.0_x86_64.rpm
