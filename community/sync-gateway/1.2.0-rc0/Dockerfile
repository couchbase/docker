...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/1.2.0/couchbase-sync-gateway-community_1.2.0-rc0_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-community_1.2.0-rc0_x86_64.rpm && \
    rm couchbase-sync-gateway-community_1.2.0-rc0_x86_64.rpm
