...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/1.1.0/couchbase-sync-gateway-community_1.1.0-forestdb_bucket_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-community_1.1.0-forestdb_bucket_x86_64.rpm && \
    rm couchbase-sync-gateway-community_1.1.0-forestdb_bucket_x86_64.rpm
