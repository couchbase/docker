...
RUN wget http://cbmobile-packages.s3.amazonaws.com/couchbase-sync-gateway-community_2.0.0-827_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-community_2.0.0-827_x86_64.rpm && \
    rm couchbase-sync-gateway-community_2.0.0-827_x86_64.rpm
